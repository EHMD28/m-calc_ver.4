    ...
    void mlog_log(const char* msg) {
        printf("[LOG]: %s\n", msg);
    }

    // ! WARNING: this function should not be called directly. Instead, use corresponding macro.
    // * Newline is included as part of function.
    void mlog_logf(const char* msg, ...) {
        va_list args;
        va_start(args, msg);
        printf("[LOG]: ");
        vprintf(msg, args);
    ...
    // ! WARNING: this function should not be called directly. Instead, use corresponding macro.
    // * Newline is included as part of function.
    void mlog_logc(const char* color, const char* msg) {
        printf("%s[LOG]: %s%s\n", color, msg, NO_COLOR);
    }

    // ! WARNING: this function should not be called directly. Instead, use corresponding macro.
    // * Newline is included as part of function.
    void mlog_logfc(const char* color, const char* msg, ...) {
        va_list args;
        va_start(args, msg);
        printf("%s[LOG]: ", color);
        vprintf(msg, args);
    ...
    void mlog_array_int(int arr[], size_t size) {
        printf("[LOG]: [");
    ...
    void mlog_array_char(char arr[], size_t size) {
        printf("[LOG]: [");
        for (size_t i = 0; i < size; i++) {
    ...
    void mlog_array_double(double arr[], size_t size) {
        printf("[LOG]: [");
        for (size_t i = 0; i < size; i++) {
    ...
    void mlog_array_str(char* arr[], size_t size) {
        printf("[LOG]: [");
        for (size_t i = 0; i < size; i++) {
    ...
    // ! WARNING: this function should not be called directly. Instead, use corresponding macro.
    // * Newline is included as part of function.
    void mlog_error(const char* msg) {
        fprintf(stderr, "[ERROR]: %s\n", msg);
    }

    // ! WARNING: this function should not be called directly. Instead, use corresponding macro.
    // * Newline is included as part of function.
    void mlog_errorf(const char* msg, ...) {
        va_list args;
        va_start(args, msg);
    ...
    // ! WARNING: this function should not be called directly. Instead, use corresponding macro.
    // * Newline is included as part of function.
    void mlog_errorc(const char* color, const char* msg) {
        fprintf(stderr, "%s[ERROR]: %s%s\n", color, msg, NO_COLOR);
    }

    // ! WARNING: this function should not be called directly. Instead, use corresponding macro.
    // * Newline is included as part of function.
    void mlog_errorfc(const char* color, const char* msg, ...) {
        va_list args;
        va_start(args, msg);
    ...
    /* testing */
    int mlog_test(int cond, const char* tag) {
        if (cond) {
    ...
    int mlog_testc(const char* color, int cond, const char* tag) {
        if (cond) {
